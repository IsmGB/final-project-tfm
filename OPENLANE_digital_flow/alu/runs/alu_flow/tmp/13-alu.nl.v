module alu (control,
 ...
 sky130_fd_sc_hd__xnor2_2 _1898_ (.A(net41),
    .B(_1004_),
    .Y(_1005_));
 sky130_fd_sc_hd__xnor2_1 _1899_ (.A(net9),
    .B(_1005_),
    .Y(_1006_));
 ...
 sky130_fd_sc_hd__clkbuf_1 rebuffer2 (.A(net101),
    .X(net102));
 sky130_fd_sc_hd__buf_1 rebuffer3 (.A(_0450_),
    .X(net103));
 sky130_fd_sc_hd__buf_1 rebuffer4 (.A(_0441_),
    .X(net104));
 sky130_fd_sc_hd__clkbuf_1 rebuffer5 (.A(_0116_),
    .X(net105));
 sky130_fd_sc_hd__buf_1 rebuffer6 (.A(_0223_),
    .X(net106));
 sky130_fd_sc_hd__buf_1 rebuffer7 (.A(_1026_),
    .X(net107));
 sky130_fd_sc_hd__clkbuf_1 rebuffer8 (.A(_0975_),
    .X(net108));
 sky130_fd_sc_hd__clkbuf_1 rebuffer9 (.A(_0975_),
    .X(net109));
 ...
 sky130_fd_sc_hd__clkbuf_1 rebuffer20 (.A(net119),
    .X(net120));
 sky130_fd_sc_hd__buf_1 rebuffer21 (.A(_0435_),
    .X(net121));
