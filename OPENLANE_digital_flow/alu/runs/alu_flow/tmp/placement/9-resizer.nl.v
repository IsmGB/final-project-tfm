module alu (control,
 ...
 sky130_fd_sc_hd__nand2_1 _1145_ (.A(_0030_),
    .B(_0041_),
    .Y(_0051_));
 sky130_fd_sc_hd__xnor2_1 _1146_ (.A(net6),
    .B(net38),
    .Y(_0061_));
 ...
 sky130_fd_sc_hd__nand2_1 _1152_ (.A(_0103_),
    .B(_0114_),
    .Y(_0125_));
 sky130_fd_sc_hd__nand4_1 _1153_ (.A(_0051_),
    .B(_0061_),
    .C(_0093_),
    .D(_0125_),
    .Y(_0135_));
 ...
 sky130_fd_sc_hd__nand2_1 _1162_ (.A(_0209_),
    .B(_0220_),
    .Y(_0231_));
 sky130_fd_sc_hd__clkbuf_2 _1163_ (.A(net37),
    .X(_0241_));
 ...
 sky130_fd_sc_hd__inv_2 _1169_ (.A(net62),
    .Y(_0289_));
 sky130_fd_sc_hd__buf_2 _1170_ (.A(_0289_),
    .X(_0290_));
 ...
 sky130_fd_sc_hd__o21a_1 _1172_ (.A1(_0167_),
    ...
    .B1(_0291_),
    .X(_0292_));
 sky130_fd_sc_hd__buf_2 _1173_ (.A(net63),
    .X(_0293_));
 ...
 sky130_fd_sc_hd__buf_2 _1305_ (.A(_0424_),
    .X(_0425_));
 sky130_fd_sc_hd__buf_2 _1306_ (.A(_0425_),
    .X(_0426_));
 ...
 sky130_fd_sc_hd__a31o_1 _1311_ (.A1(_0426_),
    ...
    .B1(_0430_),
    .X(_0431_));
 sky130_fd_sc_hd__or4_2 _1312_ (.A(net58),
    .B(net57),
    .C(net56),
    .D(net55),
    .X(_0432_));
 sky130_fd_sc_hd__or2_1 _1313_ (.A(net54),
    .B(net53),
    .X(_0433_));
 sky130_fd_sc_hd__or4_1 _1314_ (.A(net52),
    .B(net51),
    .C(net50),
    .D(net49),
    .X(_0434_));
 sky130_fd_sc_hd__or4_1 _1315_ (.A(net39),
    .B(net38),
    .C(net68),
    .D(net67),
    .X(_0435_));
 sky130_fd_sc_hd__or4_1 _1316_ (.A(_0432_),
    .B(_0433_),
    .C(_0434_),
    .D(_0435_),
    .X(_0436_));
 sky130_fd_sc_hd__or4_1 _1317_ (.A(net47),
    ...
    .D(net44),
    .X(_0437_));
 sky130_fd_sc_hd__or4_1 _1318_ (.A(net43),
    .B(net42),
    .C(net41),
    .D(net40),
    .X(_0438_));
 sky130_fd_sc_hd__or2_2 _1319_ (.A(_0437_),
    .B(_0438_),
    .X(_0439_));
 sky130_fd_sc_hd__or4_1 _1320_ (.A(net66),
    .B(net65),
    .C(net61),
    .D(net60),
    .X(_0440_));
 sky130_fd_sc_hd__nor3_2 _1321_ (.A(_0436_),
    ...
    .C(_0440_),
    .Y(_0441_));
 sky130_fd_sc_hd__buf_2 _1322_ (.A(_0441_),
    .X(_0442_));
 ...
 sky130_fd_sc_hd__or2_1 _1327_ (.A(net64),
    .B(net63),
    .X(_0447_));
 sky130_fd_sc_hd__buf_2 _1328_ (.A(_0447_),
    .X(_0448_));
 ...
 sky130_fd_sc_hd__or4_4 _1330_ (.A(net37),
    ...
    .D(net59),
    .X(_0450_));
 sky130_fd_sc_hd__buf_2 _1331_ (.A(_0450_),
    .X(_0451_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _1341_ (.A(_0460_),
    .X(_0461_));
 sky130_fd_sc_hd__buf_2 _1342_ (.A(_0441_),
    .X(_0462_));
 ...
 sky130_fd_sc_hd__or2_1 _1348_ (.A(_0466_),
    .B(_0467_),
    .X(_0468_));
 sky130_fd_sc_hd__clkbuf_4 _1349_ (.A(_0188_),
    .X(_0469_));
 ...
 sky130_fd_sc_hd__or2_1 _1366_ (.A(_0484_),
    .B(_0485_),
    .X(_0486_));
 sky130_fd_sc_hd__buf_2 _1367_ (.A(_0441_),
    .X(_0487_));
 ...
 sky130_fd_sc_hd__nand2_1 _1374_ (.A(_0491_),
    .B(_0493_),
    .Y(_0494_));
 sky130_fd_sc_hd__clkbuf_4 _1375_ (.A(_0178_),
    .X(_0495_));
 sky130_fd_sc_hd__clkbuf_4 _1376_ (.A(_0495_),
    .X(_0496_));
 sky130_fd_sc_hd__clkbuf_4 _1377_ (.A(_0496_),
    .X(_0497_));
 sky130_fd_sc_hd__buf_2 _1378_ (.A(_0252_),
    .X(_0498_));
 sky130_fd_sc_hd__nand3_1 _1379_ (.A(_0498_),
    .B(net16),
    .C(_0462_),
    .Y(_0499_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _1381_ (.A(_0500_),
    .X(_0501_));
 sky130_fd_sc_hd__or2_1 _1382_ (.A(net37),
    .B(net48),
    .X(_0502_));
 sky130_fd_sc_hd__or2_1 _1383_ (.A(_0444_),
    .B(_0502_),
    .X(_0503_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _1385_ (.A(_0504_),
    .X(_0505_));
 sky130_fd_sc_hd__buf_2 _1386_ (.A(_0462_),
    .X(_0506_));
 ...
 sky130_fd_sc_hd__buf_2 _1391_ (.A(_0293_),
    .X(_0511_));
 sky130_fd_sc_hd__buf_2 _1392_ (.A(_0511_),
    .X(_0512_));
 sky130_fd_sc_hd__a31o_1 _1393_ (.A1(_0483_),
    ...
    .B1(_0512_),
    .X(_0513_));
 sky130_fd_sc_hd__buf_2 _1394_ (.A(_0511_),
    .X(_0514_));
 ...
 sky130_fd_sc_hd__mux2_1 _1424_ (.A0(_0540_),
    ...
    .S(_0496_),
    .X(_0544_));
 sky130_fd_sc_hd__buf_2 _1425_ (.A(_0481_),
    .X(_0545_));
 ...
 sky130_fd_sc_hd__a22o_1 _1468_ (.A1(_0481_),
    ...
    .B2(_0586_),
    .X(_0587_));
 sky130_fd_sc_hd__buf_2 _1469_ (.A(_0487_),
    .X(_0588_));
 ...
 sky130_fd_sc_hd__nor2_1 _1531_ (.A(_0647_),
    .B(_0649_),
    .Y(_0650_));
 sky130_fd_sc_hd__or4b_1 _1532_ (.A(net2),
    .B(net4),
    .C(net3),
    .D_N(net1),
    .X(_0651_));
 sky130_fd_sc_hd__clkbuf_4 _1533_ (.A(_0651_),
    .X(_0652_));
 ...
 sky130_fd_sc_hd__or2_1 _1551_ (.A(_0666_),
    .B(_0668_),
    .X(_0669_));
 sky130_fd_sc_hd__xor2_1 _1552_ (.A(net27),
    .B(_0669_),
    .X(_0670_));
 ...
 sky130_fd_sc_hd__buf_2 _1625_ (.A(_0555_),
    .X(_0742_));
 sky130_fd_sc_hd__buf_2 _1626_ (.A(_0742_),
    .X(_0743_));
 sky130_fd_sc_hd__buf_2 _1627_ (.A(_0421_),
    .X(_0744_));
 ...
 sky130_fd_sc_hd__o21ai_1 _1680_ (.A1(_0301_),
    ...
    .B1(_0767_),
    .Y(_0795_));
 sky130_fd_sc_hd__buf_2 _1681_ (.A(_0744_),
    .X(_0796_));
 ...
 sky130_fd_sc_hd__a311o_1 _1785_ (.A1(_0458_),
    ...
    .C1(_0896_),
    .X(_0897_));
 sky130_fd_sc_hd__buf_2 _1786_ (.A(_0553_),
    .X(_0898_));
 sky130_fd_sc_hd__buf_2 _1787_ (.A(_0898_),
    .X(_0899_));
 ...
 sky130_fd_sc_hd__xor2_1 _1823_ (.A(net6),
    .B(_0932_),
    .X(_0933_));
 sky130_fd_sc_hd__nand3_1 _1824_ (.A(_0925_),
    .B(_0929_),
    .C(_0933_),
    .Y(_0934_));
 ...
 sky130_fd_sc_hd__and3_1 _1872_ (.A(_0933_),
    ...
    .C(_0957_),
    .X(_0980_));
 sky130_fd_sc_hd__or3b_1 _1873_ (.A(_0876_),
    .B(_0927_),
    .C_N(_0980_),
    .X(_0981_));
 ...
 sky130_fd_sc_hd__a21bo_1 _1900_ (.A1(_0979_),
    ...
    .B1_N(_0977_),
    .X(_1007_));
 sky130_fd_sc_hd__xnor2_1 _1901_ (.A(_1006_),
    .B(_1007_),
    .Y(_1008_));
 ...
 sky130_fd_sc_hd__o21a_1 _1917_ (.A1(net41),
    ...
    .B1(_0652_),
    .X(_1023_));
 sky130_fd_sc_hd__or3b_1 _1918_ (.A(_0975_),
    .B(_1023_),
    .C_N(net42),
    .X(_1024_));
 sky130_fd_sc_hd__o21bai_1 _1919_ (.A1(_0975_),
    .A2(_1023_),
    .B1_N(net42),
    .Y(_1025_));
 sky130_fd_sc_hd__and3_1 _1920_ (.A(net10),
    ...
    .C(_1025_),
    .X(_1026_));
 sky130_fd_sc_hd__a21oi_1 _1921_ (.A1(_1024_),
    .A2(_1025_),
    .B1(net10),
    .Y(_1027_));
 sky130_fd_sc_hd__nor2_1 _1922_ (.A(_1026_),
    .B(_1027_),
    .Y(_1028_));
 ...
 sky130_fd_sc_hd__a31o_1 _1926_ (.A1(_0979_),
    ...
    .B1(_1031_),
    .X(_1032_));
 sky130_fd_sc_hd__xor2_1 _1927_ (.A(_1028_),
    .B(_1032_),
    .X(_1033_));
 ...
 sky130_fd_sc_hd__a21o_1 _1950_ (.A1(_1028_),
    ...
    .B1(_1026_),
    .X(_1055_));
 sky130_fd_sc_hd__xor2_1 _1951_ (.A(_1054_),
    .B(_1055_),
    .X(_1056_));
 ...
 sky130_fd_sc_hd__nand2_1 _1974_ (.A(_0977_),
    .B(_0978_),
    .Y(_1078_));
 sky130_fd_sc_hd__or4bb_1 _1975_ (.A(_1078_),
    .B(_1006_),
    .C_N(_1028_),
    .D_N(_1054_),
    .X(_1079_));
 sky130_fd_sc_hd__or2b_1 _1976_ (.A(_1079_),
    .B_N(_0984_),
    .X(_1080_));
 sky130_fd_sc_hd__or3_1 _1977_ (.A(_0881_),
    .B(_0981_),
    .C(_1079_),
    .X(_1081_));
 sky130_fd_sc_hd__or2_1 _1978_ (.A(_1026_),
    .B(_1052_),
    .X(_1082_));
 ...
 sky130_fd_sc_hd__and4b_1 _1984_ (.A_N(net3),
    ...
    .D(_0398_),
    .X(_1088_));
 sky130_fd_sc_hd__and3_1 _1985_ (.A(net29),
    .B(_1088_),
    .C(_0448_),
    .X(_1089_));
 ...
 sky130_fd_sc_hd__o41a_1 _2043_ (.A1(net46),
    ...
    .B1(_0922_),
    .X(_0002_));
 sky130_fd_sc_hd__xnor2_1 _2044_ (.A(_0373_),
    .B(_0002_),
    .Y(_0003_));
 sky130_fd_sc_hd__xnor2_1 _2045_ (.A(_0001_),
    .B(_0003_),
    .Y(_0004_));
 ...
 sky130_fd_sc_hd__a21oi_1 _2050_ (.A1(_0356_),
    ...
    .B1(_1090_),
    .Y(_0009_));
 sky130_fd_sc_hd__nor2_1 _2051_ (.A(_0290_),
    .B(_0293_),
    .Y(_0010_));
 ...
 sky130_fd_sc_hd__mux2_1 _2054_ (.A0(_0012_),
    ...
    .S(_0545_),
    .X(_0013_));
 sky130_fd_sc_hd__nor2_1 _2055_ (.A(_0459_),
    .B(_0293_),
    .Y(_0014_));
 ...
 sky130_fd_sc_hd__nor2_1 _2071_ (.A(_1128_),
    .B(_0004_),
    .Y(_0031_));
 sky130_fd_sc_hd__or4b_1 _2072_ (.A(_1077_),
    .B(_1107_),
    .C(_1108_),
    .D_N(_0031_),
    .X(_0032_));
 ...
 sky130_fd_sc_hd__buf_1 _2081_ (.A(_0040_),
    .X(net81));
 sky130_fd_sc_hd__buf_2 _2082_ (.A(_0922_),
    .X(_0042_));
 ...
 sky130_fd_sc_hd__or2_1 _2089_ (.A(_0598_),
    .B(_0590_),
    .X(_0049_));
 sky130_fd_sc_hd__mux4_1 _2090_ (.A0(_0049_),
    .A1(_0011_),
    .A2(_1112_),
    .A3(_1062_),
    .S0(_0495_),
 ...
 sky130_fd_sc_hd__o41a_1 _2100_ (.A1(net50),
    ...
    .B1(_0922_),
    .X(_0060_));
 sky130_fd_sc_hd__xor2_1 _2101_ (.A(net51),
    .B(_0060_),
    .X(_0062_));
 ...
 sky130_fd_sc_hd__nand2_1 _2224_ (.A(_0497_),
    .B(_0148_),
    .Y(_0192_));
 sky130_fd_sc_hd__o21ai_1 _2225_ (.A1(_0497_),
    .A2(_0191_),
    .B1(_0192_),
    .Y(_0193_));
 ...
 sky130_fd_sc_hd__o31a_1 _2279_ (.A1(_0993_),
    ...
    .B1(_0249_),
    .X(_0250_));
 sky130_fd_sc_hd__or4b_1 _2280_ (.A(_1089_),
    .B(_0238_),
    .C(_0246_),
    .D_N(_0250_),
    .X(_0251_));
 ...
 sky130_fd_sc_hd__clkbuf_2 input5 (.A(data_in1[0]),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_4 input6 (.A(data_in1[10]),
    .X(net6));
 ...
 sky130_fd_sc_hd__clkbuf_4 input15 (.A(data_in1[19]),
    .X(net15));
 sky130_fd_sc_hd__buf_2 input16 (.A(data_in1[1]),
    .X(net16));
 sky130_fd_sc_hd__clkbuf_4 input17 (.A(data_in1[20]),
    .X(net17));
 ...
 sky130_fd_sc_hd__buf_4 input20 (.A(data_in1[23]),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_4 input21 (.A(data_in1[24]),
    .X(net21));
 ...
 sky130_fd_sc_hd__buf_4 input29 (.A(data_in1[31]),
    .X(net29));
 sky130_fd_sc_hd__clkbuf_4 input30 (.A(data_in1[3]),
    .X(net30));
 ...
 sky130_fd_sc_hd__clkbuf_1 input34 (.A(data_in1[7]),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_4 input35 (.A(data_in1[8]),
    .X(net35));
 sky130_fd_sc_hd__clkbuf_4 input36 (.A(data_in1[9]),
    .X(net36));
 sky130_fd_sc_hd__buf_2 input37 (.A(data_in2[0]),
    .X(net37));
 sky130_fd_sc_hd__buf_2 input38 (.A(data_in2[10]),
    .X(net38));
 sky130_fd_sc_hd__buf_2 input39 (.A(data_in2[11]),
    .X(net39));
 sky130_fd_sc_hd__buf_2 input40 (.A(data_in2[12]),
    .X(net40));
 sky130_fd_sc_hd__buf_2 input41 (.A(data_in2[13]),
    .X(net41));
 sky130_fd_sc_hd__buf_2 input42 (.A(data_in2[14]),
    .X(net42));
 sky130_fd_sc_hd__clkbuf_2 input43 (.A(data_in2[15]),
    .X(net43));
 ...
 sky130_fd_sc_hd__buf_4 input46 (.A(data_in2[18]),
    .X(net46));
 sky130_fd_sc_hd__dlymetal6s2s_1 input47 (.A(data_in2[19]),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_2 input48 (.A(data_in2[1]),
    .X(net48));
 sky130_fd_sc_hd__clkbuf_4 input49 (.A(data_in2[20]),
    .X(net49));
 sky130_fd_sc_hd__clkbuf_4 input50 (.A(data_in2[21]),
    .X(net50));
 sky130_fd_sc_hd__buf_2 input51 (.A(data_in2[22]),
    .X(net51));
 sky130_fd_sc_hd__clkbuf_4 input52 (.A(data_in2[23]),
    .X(net52));
 sky130_fd_sc_hd__clkbuf_4 input53 (.A(data_in2[24]),
    .X(net53));
 ...
 sky130_fd_sc_hd__buf_4 input58 (.A(data_in2[29]),
    .X(net58));
 sky130_fd_sc_hd__buf_2 input59 (.A(data_in2[2]),
    .X(net59));
 sky130_fd_sc_hd__buf_2 input60 (.A(data_in2[30]),
    .X(net60));
 sky130_fd_sc_hd__buf_1 input61 (.A(data_in2[31]),
    .X(net61));
 sky130_fd_sc_hd__clkbuf_4 input62 (.A(data_in2[3]),
    .X(net62));
 sky130_fd_sc_hd__buf_2 input63 (.A(data_in2[4]),
    .X(net63));
 sky130_fd_sc_hd__clkbuf_2 input64 (.A(data_in2[5]),
    .X(net64));
 sky130_fd_sc_hd__clkbuf_4 input65 (.A(data_in2[6]),
    .X(net65));
 sky130_fd_sc_hd__clkbuf_4 input66 (.A(data_in2[7]),
    .X(net66));
 sky130_fd_sc_hd__buf_2 input67 (.A(data_in2[8]),
    .X(net67));
 sky130_fd_sc_hd__clkbuf_2 input68 (.A(data_in2[9]),
    .X(net68));
