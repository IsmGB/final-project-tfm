module alu (control,
 ...
 sky130_fd_sc_hd__a21oi_1 _1921_ (.A1(net123),
    ...
    .B1(net10),
    .Y(_1027_));
 sky130_fd_sc_hd__nor2_4 _1922_ (.A(_1026_),
    .B(_1027_),
    .Y(_1028_));
 ...
 sky130_fd_sc_hd__a21oi_1 _2190_ (.A1(_0153_),
    ...
    .B1(_0898_),
    .Y(_0156_));
 sky130_fd_sc_hd__or4_4 _2191_ (.A(_1090_),
    .B(_0142_),
    .C(_0145_),
    .D(_0156_),
    .X(_0158_));
 ...
 sky130_fd_sc_hd__or2_1 _2252_ (.A(_0219_),
    .B(_0221_),
    .X(_0222_));
 sky130_fd_sc_hd__a21oi_4 _2253_ (.A1(_0212_),
    .A2(_0215_),
    .B1(_0222_),
    .Y(_0223_));
 ...
 sky130_fd_sc_hd__a211o_1 _2314_ (.A1(_0349_),
    ...
    .C1(_0286_),
    .X(_0287_));
 sky130_fd_sc_hd__o32a_4 _2315_ (.A1(_0572_),
    .A2(_0275_),
    .A3(_0276_),
    .B1(_0277_),
    .B2(_0287_),
 ...
 sky130_fd_sc_hd__clkbuf_4 input36 (.A(data_in1[9]),
    .X(net36));
 sky130_fd_sc_hd__buf_8 input37 (.A(data_in2[0]),
    .X(net37));
 ...
 sky130_fd_sc_hd__buf_2 output100 (.A(net100),
    .X(data_out[9]));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_0104_),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(net101),
    .X(net102));
 sky130_fd_sc_hd__clkbuf_2 rebuffer3 (.A(_0450_),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_0441_),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(_0116_),
    .X(net105));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer6 (.A(_0223_),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(_1026_),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(_0975_),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(_0975_),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(_0975_),
    .X(net110));
 sky130_fd_sc_hd__clkbuf_2 split11 (.A(_0487_),
    .X(net111));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer12 (.A(_0031_),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(_1028_),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(_1006_),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer15 (.A(_1006_),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer16 (.A(_1072_),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer17 (.A(_1054_),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer18 (.A(_1054_),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer19 (.A(_0933_),
    .X(net119));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer20 (.A(net119),
    .X(net120));
 sky130_fd_sc_hd__clkbuf_2 rebuffer21 (.A(_0435_),
    .X(net121));
 sky130_fd_sc_hd__clkbuf_1 rebuffer22 (.A(net121),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(_1024_),
    .X(net123));
